...
public class SettingsTabView extends StackPane {
    ...
    public SettingsTabView(String title){
        ...
        this.backButton = new ImageButton(ArrowCanvas.getArrowCanvas((int) (80 * factor), (int) (50 * factor), Settings.getActiveColorScheme().getUI()));

    }

    public void repaint(){
        this.gc.setFill(Settings.getActiveColorScheme().getBackground());
        this.gc.fillRect(0, 0, windowWidth, windowHeight);

        //Settings text
        this.gc.setFill(Settings.getActiveColorScheme().getUI());
